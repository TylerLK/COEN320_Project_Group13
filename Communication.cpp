...
void startCommSharedMemory()
{ // open shared memory to radar
...
void CommunicationCommand()
{ // send message from computer to radar for speed change
...
{ // closes all shared memory upon request and sends acknowledgment
    while (true)
    {
        if (checkTermination())
        {
